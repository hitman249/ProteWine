...
export default class WineGE extends AbstractRepository {
  protected name: string = 'Wine GE';

  protected readonly url: string = 'https://api.github.com/repos/GloriousEggroll/wine-ge-custom/releases';
